...
#define X9SD_CTRL_BASE                                                 \
    (MCCNT1_CMD_SCRAMBLE | MCCNT1_CLOCK_SCRAMBLER | \
     MCCNT1_READ_DATA_DESCRAMBLE | MCCNT1_LATENCY2(24))
#define X9SD_CTRL_POLL (X9SD_CTRL_BASE | MCCNT1_RESET_OFF | MCCNT1_LEN_0)
#define X9SD_CTRL_READ_4B (X9SD_CTRL_BASE | MCCNT1_RESET_OFF | MCCNT1_LEN_4)
#define X9SD_CTRL_READ_512B (X9SD_CTRL_BASE | MCCNT1_RESET_OFF | MCCNT1_LEN_512)
#define X9SD_CTRL_READ_1KB (X9SD_CTRL_BASE | MCCNT1_RESET_OFF | MCCNT1_LEN_1024)
