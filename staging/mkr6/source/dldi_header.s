...
@ IO_INTERFACE data -- 32 bytes
    ...
    .ascii  "MKR6"          @ ioType (Normally "DLDI")
    .word   FEATURE_MEDIUM_CANREAD | FEATURE_MEDIUM_CANWRITE | FEATURE_SLOT_NDS
    .word   MK6_StartUp         @ Function pointers to standard device driver functions
    .word   MK6_IsInserted
    .word   MK6_ReadSectors
    .word   MK6_WriteSectors
    .word   MK6_ClearStatus
    .word   MK6_Shutdown
